                       ...
                       <li>
                           <a href="https://fitfood.vn/product/full" class="link"style="text-decoration: none">
                               <div class="card">
                                   ...
                                   <div class="card-body">
                                       <h5 class="card-title">Gói FULL</h5>
                                       <span class="text-dark">Giá :</span> 
                                       <span class="text-danger">750,000 VND</span>  
                                       <p class="card-text text-secondary">Gói SÁNG - TRƯA - TỐI. Ăn cả ngày phù hợp cho người bận
                                           rộn
                                       </p>  
                                   </div>
                               </div>
