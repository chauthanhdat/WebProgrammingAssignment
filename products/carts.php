      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered m-0">
              ...
              <tbody>
                ...
                <tr>
                  <td class="p-4">
                    <div class="media align-items-center mx-auto">
                      <img src="https://fitfood.vn/img/326x206/images/fit1-15815879666463.jpg" class="mx-auto d-block cart-img" alt="">
                      <div class="media-body">
                        <a href="#" class="d-block cart-title text-center">Fit 1</a>
                        <!-- <small>
                  ...
                  <td class="text-center align-middle px-0"><a href="#" class="shop-tooltip close float-none btn btn-danger" title="" data-original-title="Remove">Remove</a></td>
                </tr>

                <tr>
                  <td class="p-4">
                    <div class="media align-items-center">
                      <img src="https://fitfood.vn/img/326x206/images/fit2-15815881455314.jpg" class="mx-auto d-block cart-img" alt="">
                      <div class="media-body">
                        <a href="#" class="d-block cart-title text-center">Fit 2</a>
                        <!-- <small>
                            <span class="text-muted">Color:</span>
                ...
                <tr>
                  <td class="p-4">
                    <div class="media align-items-center">
                      <img src="https://fitfood.vn/img/326x206/images/fit3-2-15831416118117.jpg" class="mx-auto d-block cart-img" alt="">
                      <div class="media-body">
                        <a href="#" class="d-block cart-title text-center ">Fit 3</a>
                        <!-- <small>
          ...
          <div class="d-flex justify-content-end">
            ...
            <button type="button" class="btn btn-lg btn-danger mt-2">Xác nhận đơn hàng</button>
          </div>
