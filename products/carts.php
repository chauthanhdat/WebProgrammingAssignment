...
?>
        ...
        <div
          ...
          "
        >
        <h1 class="display-4 text-dark">Hãy đăng nhập để tiến hành đặt hàng nha nha</h1>
          <h2 class="mt-0 title title-center mb-3"></h2>
            <a href="../login.php" class="btn btn-success btn-sm" role="button" >Đăng nhập nào!</a>
            ...
            <div class="card" >
                        ...
                        <tr>
                          <td class='p-4 '>
                            <div class='media align-items-center'>
                              <img src=' ". get_img_link($row['fd_name']) ."'  class='d-block ui-w-40 ui-bordered mr-4'   alt=''>
                              <div class='media-body'>
                                <a href='" .get_food_link($row['fd_name'])."' class='d-block text-dark'>".$row['fd_name']."</a>
                ...
                ?>
                    ...
                    <div class="d-flex justify-content-end">
                      ...
                      <button type="submit" form='confirm_cart' class="btn btn-lg btn-success mt-2"  name="change_num_it" >Xác nhận đơn hàng</button>
                    </div>
