...
<div class="top-inner">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-4">
                <img src="https://fitfood.vn/img/326x206/images/fit1-15815879666463.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-md-8">
                <h3 class="text-dark">GÓI FIT1</h3>
                <div class="d-flex mb-3">
                    <h4 class="text-dark me-3">GIÁ:</h4>
                    <h4 class="text-danger"><?php  echo number_format($_SESSION['food_arr_price']['GOI FIT 1']);?> VND</h4>
                </div>
                <div class="content-food mb-1">
                    <p>Gói 2 bữa SÁNG - TRƯA</p>
                    <p>- Sử dụng thực đơn 2 bữa SÁNG -TRƯA tại trang fitfood.vn/menu.</p>
                    ...
                    <p> <i> * Thích hợp cho dân văn phòng cần ít năng lượng, dành thời gian dùng bữa tối cùng gia đình</i></p>
                </div>
