    ...
    <div class="container mt-3">
        ...
        <form  action="<?php echo $_SERVER["PHP_SELF"];?>"  name="registerForm" method="post" onsubmit="return registervalidation()">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="useraccount" placeholder="Nhập tài khoản..." name="useraccount" >
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" id="re_pwd" placeholder="Nhập lại mật khẩu..." name="re_pswd" >
          </div>
          <p class="small text-danger" id="repasswrongmessage"></p>

          <div class="mb-3 mt-3">
            <label for="email">Thư điện tử:</label>
            <input type="email" class="form-control" id="email" placeholder="Nhập Thư điện tử..." name="email" >
          </div>

          <div class="mb-3 mt-3">
            <label for="Phone_number">Sổ điện thoại:</label>
            <input type="tel" class="form-control" id="phone_number" placeholder="Nhập số điện thoại" name="phone_number" >
          </div>
